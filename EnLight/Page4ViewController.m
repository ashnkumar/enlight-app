...
- (void)viewDidLoad {
    ...
    descriptionLabel.text = @"Great work! Next, let's add a beacon next to the bathroom.";
    ...
    subscriptLabel.text = @"For testing purposes, place a beacon on a different wall to simulate the bathroom.";
...
{
    [self performSegueWithIdentifier:@"toPage5" sender:self];
}
